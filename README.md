...
### 📌 Capa
![Arquitetura do Projeto](images/imagem(7).png)

### 🏗️ Arquitetura
![Arquitetura do Projeto](images/git-repositorio-local.drawio.png)
...
Embora o foco principal seja **Git Local**, este projeto também demonstra, de forma resumida, como o versionamento evolui para um fluxo moderno de **DevOps e Cloud**:
...
📌 Este fluxo representa um **deploy automatizado de site estático em produção**, porém o foco educacional principal continua sendo **Git e versionamento local**.
...
|  |  |  |
|------|-------------|---------|
| ![](images/imagem(9).png) | ![](images/imagem(10).png) | ![](images/imagem(11).png) |
| ![](images/imagem(12).png) | ![](images/imagem(13).png) | ![](images/imagem(14).png) |
| ![](images/imagem(15).png) | ![](images/imagem(16).png) | ![](images/imagem(00).png) |

📺 **Vídeo no YouTube explicando o projeto:**  
👉 [Git — Repositório Local](https://youtu.be/LAMsVNl4pwg)
